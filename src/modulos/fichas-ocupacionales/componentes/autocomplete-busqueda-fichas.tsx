...
export function AutocompleteBusquedaFichas() {
  ...
  function aplicarBusqueda(texto: string) {
    ...
    router.replace(`/fichas-ocupacionales?${siguientes.toString()}`, { scroll: false });
  }
  ...
  return (
    <BuscadorAutocompletado
      buscar={buscar}
      name="busqueda"
      placeholder="Trabajador, documento o empresa…"
